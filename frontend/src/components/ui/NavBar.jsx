      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className={`d-flex align-items-center ${styles.actions}`}>
            ...
            <Link className={`btn ${styles.actionButton}`} to="/login">
              Login
            </Link>
            <Link className={`btn ${styles.actionButton}`} to="/signup">
              Register
            </Link>
            <Link className={`btn ${styles.createButton}`} to="/add-note">
              Create
            </Link>
            <Link className={`btn ${styles.logoutButton}`} href="#logout">
              Logout
            </Link>
          </div>
        </div>
